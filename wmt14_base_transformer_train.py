...
def cli_main(
    ...
    lightconv_option = ['data-bin/wmt14_en_de',
                        ...
                        '--restore-file', 'checkpoints/wmt14_transformer_vasawani/checkpoint_best.pt',
                        '--update-freq', '1',
                        '--save-dir', 'checkpoints/wmt14_transformer_vasawani/']
